...
export const SYSTEM_FIELDS: FieldSpec[] = [
  ...
  { key: 'onlineLink',       label: 'Online Event Link',  fieldType: 'text',     required: false, defaultValue: 'Link will be shared soon', section: 'venue', order: 25, helpText: 'Required for virtual and hybrid events', form: 'Basic Info', category: 'Venue', formOrder: 0, categoryOrder: 2 },
  ...
  { key: 'coverImage',       label: 'Event Cover Image',  fieldType: 'file_image', required: true,  section: 'media', order: 50, helpText: 'Recommended size: 1200x600px', form: 'Basic Info', category: 'Media', formOrder: 0, categoryOrder: 4 },
  { key: 'bannerImage',      label: 'Secondary Banner',   fieldType: 'file_image', required: false, section: 'media', order: 51, form: 'Basic Info', category: 'Media', formOrder: 0, categoryOrder: 4 },
