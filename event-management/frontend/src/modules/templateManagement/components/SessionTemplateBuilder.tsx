...
export const SessionTemplateBuilder: React.FC<Props> = ({ sessions, onChange }) => {
            ...
            <div key={idx} className="border border-gray-200 rounded-xl overflow-hidden bg-white">
              ...
              >
                ...
                <button type="button" onClick={(e) => { e.stopPropagation(); remove(idx); }}
                  className="text-red-300 hover:text-red-500 p-1 transition flex-shrink-0">
                ...
                <div className="p-4 space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <select className={inp} value={s.sessionType}
